...
class HeaderComponent extends LitElement {
  ...
  constructor() {
    super();
    this.mainNavItems = ["inicio", "productos", "nosotros"];
    this.mainPaths = ["/", " ", "/nosotros"];
    this.subNavItems = [
      "mármol",
      "canteras",
      "granito",
      ...
      <div class="header-content auto-flex-between">
        <div class="header-content-left auto-flex-start">
          <div class="logo-nav auto-flex-start">
            <a href="/" class="home-link" @click="${this.logoClickHandler}">
              <img
                src="../../css/images/png/logo-oliman.png"
                width="60"
                height="60"
                alt="logo de oliman stone"
              />
            </a>
            <h3 class="logo-title">OLIMAN STONE</h3>
        ...
        <div class="header-content-right auto-flex-start">
...
class FooterComponent extends LitElement {
  ...
  constructor() {
    super();
    this.mainNavItems = ["inicio", "nosotros", "contacto"];
    this.mainPaths = ["/", "/nosotros ", "/contacto"];
    this.subNavItems = [
      "mármol",
      "canteras",
      "granito",
    ...
    return html`
      <div class="content-wrapper center-top-wrap footer-content">
        <div class="auto-flex-start footer-top-one">
          ...
          <div class="auto-flex-col phones">
            <h3>CONTACTO</h3>
            <ul class="auto-flex-col">
              <li>
                <a
                  href="mailto:bcoliman@yahoo.com.mx"
                  aria-label="mandar un correo electronico al correo indicado"
                >
        ...
        <div class="footer-bottom">
          <small class="copyright">
            &copy; Oliman Stone ${new Date().getFullYear()}
          </small>
        </div>
      </div>
    `;
